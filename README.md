...
**Not started:** AI photo meal estimate (FRG-303, needs a vision-model decision first), sleep modifier activation (FRG-305, depends on FRG-304), offline logging + sync queue (FRG-114). See `../engineering-backlog.html`.
